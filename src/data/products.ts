...
export const products: Product[] = [
  {
    ...
    price: 4,
    image: '/images/cookies/classic-chocolate-chip.svg',
  ...
  },
  {
    ...
    price: 4.5,
    image: '/images/cookies/double-chocolate.svg',
    allergens: ['milk', 'eggs', 'wheat'],
    featured: true,
  },
  {
    ...
    price: 4,
    image: '/images/cookies/oatmeal-raisin.svg',
  ...
  },
  {
    ...
    price: 3.5,
    image: '/images/cookies/snickerdoodle.svg',
    allergens: ['milk', 'eggs', 'wheat'],
    featured: false,
  },
  {
    ...
    price: 4.5,
    image: '/images/cookies/chocolate-peanut-butter.svg',
    allergens: ['milk', 'eggs', 'wheat', 'peanuts'],
    featured: false,
  },
  {
    ...
    price: 3.5,
    image: '/images/cookies/lemon-drop.svg',
    allergens: ['milk', 'eggs', 'wheat'],
    featured: false,
  },
];
